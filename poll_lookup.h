...
#define COL_TEMP 5
#define COL_IWS 6
#define MAX_SIZE_DATESTR 11 // Max size for a date string of form YYYY-MM-DD
...
extern node* add_node(node* front, int year, int month, int day, int hour, int pm25, int temp);
...
extern int parse_opts(int argc,
	char* argv[],
	char** filename,
	unsigned long* size,
	int* info,
